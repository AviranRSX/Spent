...
Transfer rows stay visible for review, but dashboard spending, cash-flow charts, category breakdowns, top merchants, and budget totals exclude them so moving money between accounts does not inflate spend.
