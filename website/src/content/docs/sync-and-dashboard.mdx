...
- **Overview**: monthly totals, "on track / heads-up / over" status pills, top spending categories, 6-month income versus expense trend, recent activity, and spending statistics.
...
Transfers are excluded from the dashboard's spending totals, trend charts, category breakdowns, top merchants, and spending statistics. They remain available in the transactions list for review.
